...
<head>
  <!-- Métadonnées essentielles pour le référencement et l'affichage -->
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>Équipe — Clinique‑École Santé</title>
  <!-- Déclaration de support des thèmes clair/sombre pour une cohérence système -->
...
<main class="container">
  ...
  <!-- Grille présentant les membres de l'équipe médicale -->
